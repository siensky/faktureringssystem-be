...
/**
 * Payload för payment.partial. Publiceras av payments när en inkommande banktransaktion delvis täcker fakturans kvarstående belopp (amountOre < remainingOre). billing konsumerar eventet och skriver den faktiska raden i invoice_payments (architecture.md #20 — payments skriver aldrig billings tabeller direkt). Eventtypen är bara informativ: billing räknar alltid om paid_ore via SUM och avgör status='paid' från det, aldrig från eventnamnet.
 */
export interface PaymentPartialPayload {
  /**
