// Små Fastify-preHandlers och request-helpers som payments lägger ovanpå
// requireUser / requireService. Ingen affärslogik — bara grindar. Kopia
// av billings guards.ts (bekräftat i fas 5-planen att det INTE ska vara
// delad kod).
...
/**
 * Idempotency-Key-headern. Obligatorisk på allt som bokför en betalning
 * (matcha/ignorera en bank_transactions-rad) — architecture.md #10.
 */
