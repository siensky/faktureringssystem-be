...
// idempotensavsnitt #3). Krävs på POST /admin/payments/:id/match och
// /:id/ignore — båda avgör en bank_transactions-rads öde permanent.
// Kopia av billings idempotency.ts (bekräftat i fas 5-planen att det INTE
// ska vara delad kod).
//
// Flöde:
