...
//
// Identisk i sak med services/billing/src/audit.ts och
// services/auth/src/audit.ts — varje tjänst håller sin egen tunna
// wrapper i stället för att dela en modul för fyra rader SQL.
